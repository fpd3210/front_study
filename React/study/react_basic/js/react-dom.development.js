...
// React.components uses a shared frozen object by default.
...
function checkClassInstance(workInProgress, ctor, newProps) {
  var instance = workInProgress.stateNode;
  {
    ...
    if (ctor.prototype && ctor.prototype.isPureReactComponent && typeof instance.shouldComponentUpdate !== 'undefined') {
      warningWithoutStack$1(false, '%s has a method called shouldComponentUpdate(). ' + 'shouldComponentUpdate should not be used when extending React.PureComponent. ' + 'Please extend React.components if shouldComponentUpdate is used.', getComponentName(ctor) || 'A pure component');
    }
...

{
  ...
  warnForMissingKey = function (child) {
    ...
    !(typeof child._store === 'object') ? invariant(false, 'React components in warnForMissingKey should have a _store. This error is likely caused by a bug in React. Please file an issue.') : void 0;
...
function warnOnFunctionType() {
  var currentComponentErrorInfo = 'Functions are not valid as a React child. This may happen if ' + 'you return a components instead of <components /> from render. ' + 'Or maybe you meant to call this function rather than return it.' + getCurrentFiberStackInDev();
  ...
  warning$1(false, 'Functions are not valid as a React child. This may happen if ' + 'you return a components instead of <components /> from render. ' + 'Or maybe you meant to call this function rather than return it.');
}
...

  {
    if (Component.prototype && typeof Component.prototype.render === 'function') {
      ...
      if (!didWarnAboutBadClass[componentName]) {
        warningWithoutStack$1(false, "The <%s /> component appears to have a render method, but doesn't extend React.components. " + 'This is likely to cause errors. Change %s to extend React.components instead.', componentName, componentName);
...
var ReactDOM = {
  ...
  unstable_renderSubtreeIntoContainer: function (parentComponent, element, containerNode, callback) {
    ...
    !(parentComponent != null && has(parentComponent)) ? invariant(false, 'parentComponent must be a valid React components') : void 0;
